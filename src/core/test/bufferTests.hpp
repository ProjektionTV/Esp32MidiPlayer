...
PROJEKTION_MIDI_TEST_START(buffer_00_passthrough)
    ...
    PROJEKTION_MIDI_TEST_BUFFER("A", "test0", 16, 50, 0, 0, 0, 0, 0)
...
PROJEKTION_MIDI_TEST_START(buffer_02_delno)
    ...
    PROJEKTION_MIDI_TEST_BUFFER(";l", "test0", 16, 50, 0, 2, 0, 0, 0)
...
PROJEKTION_MIDI_TEST_START(buffer_03_delNoPassthrough)
    ...
    PROJEKTION_MIDI_TEST_BUFFER(";lA", "test0", 16, 50, 0, 2, 0, 0, 0)
...
PROJEKTION_MIDI_TEST_START(buffer_04_mulCreate)
    ...
    PROJEKTION_MIDI_TEST_BUFFER(";ln", "test0", 16, 50, 1, 2, 1, 1, 1)
    PROJEKTION_MIDI_TEST_TICK(0, 0)
    PROJEKTION_MIDI_TEST_BUFFER(";n", "test0", 16, 50, 2, 0, 2, 1, 1)
    PROJEKTION_MIDI_TEST_TICK(0, 0)
    PROJEKTION_MIDI_TEST_BUFFER("A", "test0", 16, 50, 0, 0, 0, 0, 0)
...
PROJEKTION_MIDI_TEST_START(buffer_05_createDel)
    ...
    PROJEKTION_MIDI_TEST_BUFFER(";nB", "test0", 16, 50, 2, 0, 1, 1, 1)
    PROJEKTION_MIDI_TEST_BUFFER(";lA", "test0", 16, 50, 0, 1, 0, 0, 0)
...
PROJEKTION_MIDI_TEST_START(buffer_06_append)
    ...
    PROJEKTION_MIDI_TEST_BUFFER(";n", "test0", 16, 50, 1, 0, 1, 1, 1)
    PROJEKTION_MIDI_TEST_BUFFER(";A", "test0", 16, 50, 3, 0, 0, 1, 1)
    PROJEKTION_MIDI_TEST_BUFFER("", "test0", 16, 50, 0, 0, 0, 0, 0)
...
PROJEKTION_MIDI_TEST_START(buffer_07_appendCut)
    ...
    PROJEKTION_MIDI_TEST_BUFFER(";n", "test0", 16, 2, 1, 0, 1, 1, 1)
    PROJEKTION_MIDI_TEST_BUFFER(";AH", "test0", 16, 2, 2, 0, 0, 1, 1)
    PROJEKTION_MIDI_TEST_BUFFER("", "test0", 16, 50, 0, 0, 0, 0, 0)
...
PROJEKTION_MIDI_TEST_START(buffer_08_multibuffer)
    ...
    PROJEKTION_MIDI_TEST_BUFFER(";n A", "test0", 16, 50, 3, 0, 1, 1, 1)
    PROJEKTION_MIDI_TEST_BUFFER(";n A H C", "test1", 16, 50, 7, 0, 1, 1, 1)
    PROJEKTION_MIDI_TEST_BUFFER("", "test0", 16, 50, 0, 0, 0, 0, 0)
...
PROJEKTION_MIDI_TEST_START(buffer_09_deleteAndCreate)
    ...
    PROJEKTION_MIDI_TEST_BUFFER(";nB", "test0", 16, 50, 2, 0, 1, 1, 1)
    PROJEKTION_MIDI_TEST_BUFFER(";lnA", "test0", 16, 50, 2, 1, 1, 1, 1)
    PROJEKTION_MIDI_TEST_BUFFER("", "test0", 16, 50, 0, 0, 0, 0, 0)
